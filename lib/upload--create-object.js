...
// #################################### FILE IS NEW JOURNAL STRUCTURE ####################################
                ...
                journalStructureClassNameId = LrClassNameConfig.getSingleValue('clazz', 'com.liferay.portlet.journal.model.JournalArticle', 'id');
			...
			// FILE IS NEW (BUT NOT JOURNAL STRUCTURE)
            } else {

// #################################### FILE IS NEW SOMETHING (BUT NOT JOURNAL STRUCTURE) ####################################
				...
				console.log('Here we should upload a new DDM');
            }
...
// #################################### ASK STUFF ####################################
            ...
            if(fileClassObj.type === 'template') {
                ...
                // Set some values in our return object to be able to do a nice print to the user.
				returnObj.group.description = globalSites.getSingleValue('groupId', oldDDMObject.groupId, 'description');
				returnObj.group.name = globalSites.getSingleValue('groupId', oldDDMObject.groupId, 'name');
				returnObj.group.type = LrClassNameConfig.getSingleValue('id', globalSites.getSingleValue('groupId', oldDDMObject.groupId, 'classNameId'), 'friendlyName');
				returnObj.group.friendlyURL = globalSites.getSingleValue('groupId', oldDDMObject.groupId, 'friendlyURL');
