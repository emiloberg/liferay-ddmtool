...
var createUploadObject = function (newObj) {
	...
	// Set some values in our return object to be able to do a nice print to the user.
	returnObj.group.description = globalSites.getSingleValue('groupId', newObj.oldObj.groupId, 'description');
	returnObj.group.name = globalSites.getSingleValue('groupId', newObj.oldObj.groupId, 'name');
	returnObj.group.type = LrClassNameConfig.getSingleValue('id', globalSites.getSingleValue('groupId', newObj.oldObj.groupId, 'classNameId'), 'friendlyName');
	returnObj.group.friendlyURL = globalSites.getSingleValue('groupId', newObj.oldObj.groupId, 'friendlyURL');
