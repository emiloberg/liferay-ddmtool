...
var utilities = {
    ...
    writeToScreen: function (str, severity, type) {
        if (severity >= Fixed.debugLevel) {
            if (type == Constants.SCREEN_PRINT_INFO) {
                console.log(str);
            } else if (type == Constants.SCREEN_PRINT_SAVE) {
                console.log(clc.green(str));
            } else if (type == Constants.SCREEN_PRINT_HEADING) {
                console.log(clc.blue(str));
            } else if (type == Constants.SCREEN_PRINT_FILE) {
                console.log(clc.yellow(str));
            } else if (type == Constants.SCREEN_PRINT_ERROR) {
