...
var cache = {
	getAllCache: function () {
		...
		globalTemplates.setAll(readFileFromCache(Constants.fetch('cacheTemplatesFilename')));
		LrClassNameConfig.set(cache.readFileFromCache(Constants.fetch('cacheClassNameConfig')));
	},
